...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50),5,3,'blue',2)
    #even_better_draw_circles(rg.Point(-200, 0),10,7,'red',5)
    even_better_draw_circles(rg.Point(0,0),210,1,'blue',1)
    even_better_draw_circles(rg.Point(0, 0), 140, 1, 'red', 1)
    even_better_draw_circles(rg.Point(0, 0), 70, 1, 'yellow', 1)
...
def even_better_draw_circles(point,r,n,c,t):
    turtle = rg.SimpleTurtle()
